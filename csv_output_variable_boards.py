...
board_number = input("Enter the board number (B1, B2): ").strip().upper()
while board_number not in ["B1", "B2"]:
    board_number = input("Invalid input. Please enter B1 or B2: ").strip().upper()

serial_port = input("Enter the COM port (e.g., COM3): ").strip().upper()
baud_rate = 9600
